...
merge rule, plus derived attribute and pairing-observation rebuilds (CP5
scope — docs/DATA_FOUNDATION_PLAN.md §6, §12, §13).

Public API re-exported from the submodules. Affinity handling, duplicate
detection, and sample regeneration remain out of scope — see
